<?php
$k2_enable_section = get_theme_mod( 'k2_services_enable', true );
if ( $k2_enable_section || is_customize_preview() ) :
?>
<div id="services-section"class="services-section"  <?php if( false == $k2_enable_section ): echo 'style="display: none;"'; endif ?>>
    <div class="container">
        <div class="row">
			...
			if ( is_active_sidebar( 'services-section' ) ){
				...
				the_widget( 'k2_Service', $widget_args );

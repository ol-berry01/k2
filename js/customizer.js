jQuery(window).load(function (){
	( function( $ ) {
		...
		//Scroll to section
		$('body').on('click', '#accordion-panel-k2_front_page_sections .control-subsection .accordion-section-title', function(event) {
		...
		function scrollToSection( section_id ){
			...
			switch ( section_id ) {
				...
				case 'accordion-section-services':
			        ...
			        break;
			    case 'accordion-section-k2_quote_section':
			        section_class = "quote-section";
			        break;
			    case 'accordion-section-k2_video_section':
			        section_class = "video-section";
			        break;
			    case 'accordion-section-k2_testimonials_section':
			        section_class = "testimonials-section";
			        break;
			    case 'accordion-section-k2_image_section':
			        section_class = "image-section";
			        break;
			    case 'accordion-section-k2_team_section':
			        section_class = "team-section";
			        break;
			    case 'accordion-section-k2_phone_section':
			        section_class = "phone-section";
			        break;
			    case 'accordion-section-k2_tagline_section':
			        section_class = "tagline-section";
			        break;
			    case 'accordion-section-k2_clients_section':
			        section_class = "clients-section";
			        break;
			    case 'accordion-section-k2_map_section':
			        section_class = "map-section";
			        break;
			    case 'accordion-section-k2_pricing_section':
			        section_class = "pricing-section";
			        break;
			    case 'accordion-section-k2_portfolio_section':
			        section_class = "portfolio-section";
			        break;
			    case 'accordion-section-k2_blog_section':
		...
		//console.log("a");
		//console.log( wp.customize.control( 'k2_quote' ).section() );

jQuery(document).ready(function($) {
	...
	$destination.prepend('<a style="width: 80%; margin: 10px auto; display: block; text-align: center;" href="https://quemalabs.ticksy.com/articles/100000460/" class="button" target="_blank">{documentation}</a>'.replace( '{documentation}', topbtns.documentation ) );
 	$destination.prepend('<a style="width: 80%; margin: 10px auto; display: block; text-align: center;" href="http://www.quemalabs.com/theme/k2-pro/?utm_source=k2%20Theme&utm_medium=Pro%20Button&utm_campaign=k2%20Pro" class="button" target="_blank">{pro}</a>'.replace( '{pro}', topbtns.pro ) );
});

<?php
    ...
    //Font Awesome  ==================================================
    wp_enqueue_script( 'fontawesome', '//use.fontawesome.com/6986e38dd1.js', array(), '4.7.0', true);
    //=================================================================
	...
	//Customs Scripts =================================================
	wp_enqueue_script( 'k2_theme-custom', get_template_directory_uri() . '/js/script.js', array( 'jquery', 'bootstrap' ), '1.0', true );
	//=================================================================

...
add_action('admin_enqueue_scripts', 'k2_service_widget_scripts');

function k2_service_widget_scripts(){

    wp_enqueue_media();

    wp_enqueue_script( 'k2_service_widget_script', get_template_directory_uri() . '/js/widget.js', false, '1.0', true );

}


class k2_Service extends WP_Widget{
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_attr__( 'k2 - Service widget', 'k2' ), // Name
            array( 
                'description' => esc_attr__( 'Display a Service or Feature description.', 'k2' ),
            )
        );
    }
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('image_uri'); ?>"><?php esc_html_e('Image', 'k2'); ?></label><br/>
            ...
            <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                   name="<?php echo $this->get_field_name('image_uri'); ?>" value="<?php esc_attr_e( 'Upload Image', 'k2' ); ?>"
                   style="margin-top:5px;"/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('text'); ?>"><?php esc_html_e( 'Text', 'k2' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('link'); ?>"><?php esc_html_e( 'Link','k2' ); ?></label><br />

...
class k2_Pricing extends WP_Widget{
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_attr__( 'k2 - Pricing widget', 'k2' ), // Name
            array( 
                'description' => esc_attr__( 'Display a pricing list.', 'k2' ),
            )
        );
    }
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e( 'Title', 'k2' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('currency'); ?>"><?php esc_html_e( 'Currency', 'k2' ); ?> <small><?php esc_html_e( 'Example: $', 'k2' ); ?></small></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('price'); ?>"><?php esc_html_e( 'Price', 'k2' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('duration'); ?>"><?php esc_html_e( 'Duration', 'k2' ); ?> <small><?php esc_html_e( 'Example: mo', 'k2' ); ?></small></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('features'); ?>"><?php esc_html_e( 'Features List', 'k2' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('link_title'); ?>"><?php esc_html_e( 'Link title', 'k2' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('link'); ?>"><?php esc_html_e( 'Link URL', 'k2' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('featured'); ?>"><?php esc_html_e( 'Featured?', 'k2' ); ?></label><br/>
